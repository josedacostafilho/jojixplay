...
11. `PosePacket` remains in raw phone-camera coordinates. Television mirroring, drawing, Bubbles simulation/input, cursor projection, adaptive layout, and hit testing share one presentation transform and never mutate transport data or swap anatomical landmark indices.
